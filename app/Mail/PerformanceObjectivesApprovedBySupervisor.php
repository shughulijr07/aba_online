...
class PerformanceObjectivesApprovedBySupervisor extends Mailable
{
    ...
    {
        return $this->markdown('emails.performance_objectives.performance_objectives_approved_by_supervisor_email');
    }
}
