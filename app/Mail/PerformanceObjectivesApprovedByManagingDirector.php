...
class PerformanceObjectivesApprovedByManagingDirector extends Mailable
{
    /**
     * @var
     */
    ...
    {
        return $this->markdown('emails.performance_objectives.performance_objectives_approved_by_md_email');
    }
}
