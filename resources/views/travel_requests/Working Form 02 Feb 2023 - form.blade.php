...
<div class="row">
    ...
    <div class="col-sm-12" >
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title text-danger">Travel Request Form</h5>
                                ...
                                @else
                                    ...
                                    <!-- Header-->
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="departure_date" id="departure_date" type="text" class="form-control @error('departure_date') is-invalid @enderror" value="{{ old('departure_date') ?? $travel_request->departure_date}}" autocomplete="off" {{$disabled}}>
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="returning_date" id="returning_date" type="text" class="form-control @error('returning_date') is-invalid @enderror" value="{{ old('returning_date') ?? $travel_request->returning_date}}" autocomplete="off" {{$disabled}}>
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-12" id="description_div">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <textarea name="purpose_of_trip" id="purpose_of_trip" class="form-control @error('purpose_of_trip') is-invalid @enderror" autocomplete="off" {{$disabled}}>{{ old('purpose_of_trip') ?? $travel_request->purpose_of_trip}}</textarea>
                                        ...
                                        <fieldset {{$disabled}}>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <table style="width: 100%;" id="travel_request_table" class="table table-hover table-striped table-bordered">
                                                        ...
                                                        @if(count($travel_request->lines) == 0)
                                                            <tr class="data-row" id="travel_request_table_row_1">
                                                                <td class="data-column no">
                                                                    <input name="travel_request_table_row_1[]" class="column-input row-no text-left" autocomplete="off" value="1" readonly>
                                                                </td>
                                                                ...
                                                                <td class="data-column time">
                                                                    <input name="travel_request_table_row_1[]" class="column-input activity" value="{{old('travel_request_table_row_1')[2]}}" autocomplete="off">
                                                                </td>
                                                                <td class="data-column time">
                                                                    <input name="travel_request_table_row_1[]" class="column-input rate text-right" value="{{old('travel_request_table_row_1')[3]}}" autocomplete="off" readonly>
                                                                </td>
                                                                <td class="data-column">
                                                                    <input name="travel_request_table_row_1[]" class="column-input measure" value="{{old('travel_request_table_row_1')[4]}}" autocomplete="off" readonly>
                                                                </td>
                                                                <td class="data-column text-center">
                                                                    <input name="travel_request_table_row_1[]" class="column-input unit text-right" value="{{old('travel_request_table_row_1')[5]}}" readonly>
                                                                </td>
                                                                <td class="data-column text-center">
                                                                    <input name="travel_request_table_row_1[]" class="column-input percentage text-right" value="{{old('travel_request_table_row_1')[6]}}" readonly>
                                                                </td>
                                                                <td class="data-column text-center">
                                                                    <input name="travel_request_table_row_1[]" class="column-input total-cost text-right" value="{{old('travel_request_table_row_1')[7]}}" readonly>
                                                                </td>
                                                                <td class="data-column text-center">
                                                            ...
                                                            @while(!is_null(old('travel_request_table_row_'.$m)))
                                                                <tr class="data-row" id="travel_request_table_row_{{$m}}">
                                                                    <td class="data-column no">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input row-no" autocomplete="off" value="{{$m}}" readonly>
                                                                    </td>
                                                                    <td class="data-column time">
                                                                    ...
                                                                    <td class="data-column time">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input activity" autocomplete="off" value="{{ old('travel_request_table_row_'.$m)[2] }}">
                                                                    </td>
                                                                    <td class="data-column time">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input rate text-right" autocomplete="off" value="{{ old('travel_request_table_row_'.$m)[3] }}" readonly>
                                                                    </td>
                                                                    <td class="data-column">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input measure" autocomplete="off" value="{{ old('travel_request_table_row_'.$m)[4] }}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input unit text-right"  value="{{ old('travel_request_table_row_'.$m)[5] }}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input percentage text-right"  value="{{ old('travel_request_table_row_'.$m)[6] }}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input total-cost text-right"  value="{{ old('travel_request_table_row_'.$m)[7] }}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                        ...
                                                        @else
                                                            ...
                                                            @foreach($lines as $line)
                                                                <tr class="data-row" id="travel_request_table_row_{{$n}}">
                                                                    <td class="data-column">
                                                                        <input name="travel_request_table_row_{{$n}}[]" class="column-input row-no" autocomplete="off" value="{{$n}}" readonly>
                                                                    </td>
                                                                    <td class="data-column time">
                                                                    ...
                                                                    <td class="data-column time">
                                                                        <input name="travel_request_table_row_{{$n}}[]" class="column-input activity" autocomplete="off" value="{{ old('travel_request_table_row_'.$n)[2] ?? $line[2]}}">
                                                                    </td>
                                                                    <td class="data-column time">
                                                                        <input name="travel_request_table_row_{{$n}}[]" class="column-input rate text-right" autocomplete="off" value="{{ old('travel_request_table_row_'.$n)[3] ?? $line[3]}}" readonly>
                                                                    </td>
                                                                    <td class="data-column">
                                                                        <input name="travel_request_table_row_{{$n}}[]" class="column-input measure" autocomplete="off" value="{{ old('travel_request_table_row_'.$n)[4] ?? $line[4]}}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$n}}[]" class="column-input unit text-right"  value="{{ old('travel_request_table_row_'.$n)[5] ?? $line[5]}}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$n}}[]" class="column-input percentage text-right"  value="{{ old('travel_request_table_row_'.$n)[6] ?? $line[6]}}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$n}}[]" class="column-input total-cost text-right"  value="{{ old('travel_request_table_row_'.$n)[7] ?? $line[7]}}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
                                                            ...
                                                            @while(!is_null(old('travel_request_table_row_'.$m)))
                                                                <tr class="data-row" id="travel_request_table_row_{{$m}}">
                                                                    <td class="data-column no">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input line-no" autocomplete="off" value="{{$m}}" readonly>
                                                                    </td>
                                                                    <td class="data-column time">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input account-code" autocomplete="off" value="{{ old('travel_request_table_row_'.$m)[1] }}">
                                                                    </td>
                                                        ...
                                                        <tr>
                                                            <th style="width: 5%;" ></th>
                                                            <th colspan="6" class="text-right">Total Request</th>
                                            ...
                                            I <span class="text-danger">{{$employee_name}}</span>  declare by accepting funds from CSSC that I will retire these funds according to
                                            CSSC  policies and procedures with genuine receipts.
                                        </span>
...
<script type="text/javascript">
    ...
    $("tbody").on('click','tr>td>input.rate',function(event){
        ...
        var activity = row.children("td").children(".activity");
    ...
    $("tbody").on('click','tr>td>input.measure,tr>td>input.unit,tr>td>input.percentage',function(event){
        ...
        var row = $(this).parent().parent();
        var activity = row.children("td").children(".activity");
        var measure = row.children("td").children(".measure");
        var rate = row.children("td").children(".rate");
        var unit =  row.children("td").children(".unit");
        var percentage =  row.children("td").children(".percentage");
        var total_cost =  row.children("td").children(".total-cost");

        if( activity.val() == '' || rate.val() == ''){

            sweet_alert_warning('Please fill the Activity and Rate fields first');
        }
        else if( $(this).hasClass('measure') && activity.val() == '' ){
            sweet_alert_warning('Please fill the Activity field first');
        }
        else if( $(this).hasClass('measure') && activity.val() != '' && rate.val() != '' ){
            $(this).removeAttr('readonly');
        }
        else if( ($(this).hasClass('unit') || $(this).hasClass('percentage')) && measure.val() == '' ){

            sweet_alert_warning('Please fill the Measure field first');
        }
        else if( $(this).hasClass('percentage') && unit.val() == '' ){

            sweet_alert_warning('Please fill the Unit field first');
        }
        else{
            ...
            var total = (rate.val()*unit.val()*percentage.val())/100;
    ...
    $("form").submit(function(event){
        ...
        if ( project_code === '' ) {
            ...
            var error_message = "Please enter Departure Date before submitting this Travel Request";
            sweet_alert_error(error_message);

        }
        else if ( returning_date === '' ) {

            var error_message = "Please enter Returning Date before submitting this Travel Request";
            sweet_alert_error(error_message);
    ...
    function rearrange_items_in_a_table(table_name){
        ...
        rows.each(function(){
            ...
            $(row_columns).each(function(){
                ...
                var column_input= $(this).children('input,select');
                ...
                //this is table specif demand (it is not general to all pages)
                //var column_input2= $(this).children('select');
                if( column_input.hasClass('to-be-on-medical')){
                    column_input.attr('name',row_id+'[6][]');
                }
