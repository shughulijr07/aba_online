        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                @endif
                        ...
                        <a href="{{url('/travelFilePreview',$travel_request->id)}}" class="btn btn-secondary btn-s" role="button"><i class="fa fa-file" aria-hidden="true"></i>View attached file</a>
                        @endif
                                    ...
                                    <table style="width: 100%;" id="travel_request_table" class="table table-hover table-striped table-bordered">
                                        ...
                                        @if(count($travel_request->lines) == 0)
                                            <tr class="data-row" id="travel_request_table_row_1">
                                                ...
                                                <td class="data-column time">
                                                <select name="project_code" id="activityrowu" class="form-control @error('country') is-invalid @enderror" {{$disabled}}>
