    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                ...
                <tr class='clickable-row' data-href="/travel_request/{{ $travel_request->id }}">
                    <td>{{ $n }}</td>
                    ...
                    <td>
                        <a href="/travel_request/{{ $travel_request->id }}" class="btn btn-primary btn-sm" role="button" aria-pressed="true">View</a>
                    </td>
                </tr>
                <?php $n++; ?>
                @endforeach
