    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">Traveling Records</div>
                    <div class="page-title-subheading">
                        Use the form below to filter and staff your travelling records.
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <form action="/staff_travel_records" method="POST" enctype="multipart/form-data" id="valid-form" target="_blank">
                        @csrf
                        {{ csrf_field() }}
