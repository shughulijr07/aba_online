    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">Travel Request Submitted By {{$employee_name}}</div>
                                                    ...
                                                    <div>
                                                        @if($travel_request->status == '0')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">TRAVEL REQUEST RETURNED FOR CORRECTIONS</h4>
                                                                <p>
                                                        ...
                                                        @if($travel_request->status == '10')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">TRAVEL REQUEST SUBMITTED</h4>
                                                                <p>
                                                                    Hello, your Travel Request have been submitted successfully, please wait for Supervisor Approval.<br>
                                                        ...
                                                        @if($travel_request->status == '20')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                ...
                                                                <p>
                                                                    Hello, your Travel Request have been approve by Supervisor, currently it is waiting for Accountant
                                                                     Approval.<br>
                                                        ...
                                                        @endif
                                                            ...
                                                            @if($travel_request->status == '30')
                                                                ...
                                                                <div class="vertical-timeline-element-content bounce-in">
                                                                    ...
                                                                    <p>
                                                                        Hello, your Travel Request have been approve by Accountant, currently it is waiting for Finance Director's
                                                                        Approval.<br>
                                                                        - Time of Approving | {{date("d-m-Y H:i:s", strtotime($travel_request->updated_at))}}
                                                                    </p>
                                                            ...
                                                            @if($travel_request->status == '40')
                                                                ...
                                                                <div class="vertical-timeline-element-content bounce-in">
                                                                    ...
                                                                    <p>
                                                                        Hello, your Travel Request have been approve by Finance Director, currently it is waiting for Managing Director's
                                                                        Approval.<br>
                                                                        - Time of Approving | {{date("d-m-Y H:i:s", strtotime($travel_request->updated_at))}}
                                                                    </p>
                                                            ...
                                                            @if($travel_request->status == '50')
                                                                ...
                                                                <div class="vertical-timeline-element-content bounce-in">
                                                                    ...
                                                                    <p>
                                                                        Hello, your Travel Request have been approved successfully.<br>
                                                                        - Time of Approving | {{date("d-m-Y H:i:s", strtotime($travel_request->updated_at))}}
                                                                    </p>
