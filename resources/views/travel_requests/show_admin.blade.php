            ...
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">
                        Travel Request Submitted By <span class="text-danger font-weight-bold">{{$employee_name}}</span>
                    </div>
                                                    ...
                                                    <div>
                                                        @if($travel_request->status == '0')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                ...
                                                                <p>
                                                                    This Travel Request have been returned for corrections by
                                                        ...
                                                        @if($travel_request->status == '10')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">NEW TRAVEL REQUEST SUBMITTED</h4>
                                                                <p>
                                                                    This Travel Request have been submitted by employee. Currently it is still waiting for Supervisor's Approval.<br>
                                                        ...
                                                        @if($travel_request->status == '20')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">TRAVEL REQUEST APPROVED BY SUPERVISOR</h4>
                                                                <p>
                                                                    This Travel Request have been Approved by Supervisor, currently it is waiting for Accountant Approval.<br>
                                                        ...
                                                        @if($travel_request->status == '30')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">TRAVEL REQUEST APPROVED BY ACCOUNTANT</h4>
                                                                <p>
                                                                    This Travel Request have been Approved by Accountant, currently it is waiting for
                                                        ...
                                                        @if($travel_request->status == '40')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">TRAVEL REQUEST APPROVED BY FINANCE DIRECTOR</h4>
                                                                <p>
                                                                    This Travel Request have been Approved by Finance Director, currently it is waiting for
                                                        ...
                                                        @if($travel_request->status == '50')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">TRAVEL REQUEST APPROVED</h4>
                                                                <p>
                                                                    This Travel Request have been Approved successfully.<br>
                                                                    - Time of Approval | {{date("d-m-Y H:i:s", strtotime($travel_request->updated_at))}}
                                                                </p>
                                                        ...
                                                        @if($travel_request->status == '99')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">TRAVEL REQUEST REJECTED</h4>
                                                                <p>
                                    ...
                                    <div class="">
                                        <div class="">
                                            ...
                                            <div class="p-3" id="approve_travel_request_div">
                                                <form action="/approve_travel_request" method="POST" enctype="multipart/form-data" id="approve_travel_request_form">
                                                    @csrf
                                                    {{ csrf_field() }}
                                                    ...
                                                    <button class="mt-2 btn btn-primary" id="approve_travel_request_btn">Approve Travel Request</button>
                                                </form>
                                            </div>
                                            <div class="p-3" id="return_travel_request_div" style="display: none;">
                                                <form action="/return_travel_request" method="POST" enctype="multipart/form-data" id="return_travel_request_form">
                                                    @csrf
                                                    {{ csrf_field() }}
                                            ...
                                            <div class="p-3" id="reject_travel_request_div" style="display: none;">
                                                <form action="/reject_travel_request" method="POST" enctype="multipart/form-data" id="reject_form">
                                                    @csrf
                                                    {{ csrf_field() }}
