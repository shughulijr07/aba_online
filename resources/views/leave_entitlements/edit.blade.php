                ...
                <div class="col-md-8">
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form action="/leave_entitlements/{{$leave_entitlement->id}}" method="POST" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                @include('leave_entitlements.form_edit')
                                <button class="mt-2 btn btn-primary">Update Entitlement</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <table style="width: 100%;" id="suggestion-table" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                @foreach( $leave_types['objects'] as $leave_type)
                                    <tr class='data-row'>
