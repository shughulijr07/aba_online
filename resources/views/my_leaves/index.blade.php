    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">Employee Leaves</div>
                    <div class="page-title-subheading">
                        Use the form below to filter and see all leaves you have already taken previously.
                    </div>
                </div>
            </div>
    ...
    <div class="tab-content">
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5 class="card-title text-danger">Leave Filtering Form</h5>

                    <form action="/my_leaves" method="POST" enctype="multipart/form-data" id="valid-form" target="_blank">
                        @csrf
                        {{ csrf_field() }}
                                    ...
                                    <div class="position-relative form-group">
                                        ...
                                        <select name="leave_type" id="leave_type" class="form-control">
                                            ...
                                            @foreach($leave_types as $key=>$leave_details)
                                                <option value="{{$key}}">{{$leave_details['name']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
