...
# Leave Plan Approved By Human Resource Manager

<p>
    Hello {{$recipient->first_name}}, your Leave Plan for the year
    {{$leave_plan->year}} have been Approved by Human Resource Manager.<br>
...
<p>
    ...
    for the year {{$leave_plan->year}} have been Approved by Human Resource Manager.<br>
    - Time of Approval | {{date("d-m-Y H:i:s", strtotime($leave_plan->updated_at))}}<br>
