...
# Travel Request Approved By Finance Director
...
<p>
    ...
    have been Approved by Finance Director.<br>
...
<p>
    ...
    with departure date of {{date("d-m-Y", strtotime($travel_request->departure_date))}}
    and returning date of {{date("d-m-Y", strtotime($travel_request->returning_date))}}
    have been Approved by Finance Director, currently it is waiting for Your Approval.
