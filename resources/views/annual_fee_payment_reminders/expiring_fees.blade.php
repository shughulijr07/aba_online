...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5 class="card-title mb-3">Members Who Are <span class="text-danger">Not Yet Reminded ({{count($unattended_reminders)}})</span></h5>
        ...
        <div class="col-sm-5">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <div class="col-md-12 pt-3 pb-4" style="border:1px solid #EFEFEF; display: none;" id="marking_form_div">
                        <form action="/annual_fee_payment_reminders" method="POST" enctype="multipart/form-data" id="marking_form">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="reminder_type" id="reminder_type" value="expiring_fees" style="display: none;" autocomplete="off">
                            </div>
                            <div id="save_barcode_section">
                                <button class="mt-2 btn btn-primary col-md-12" id="save_barcode_btn">Mark As Reminded</button>
                            </div>
                        </form>
                    </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title mb-3">Members Who Are <span class="text-danger">Have Already Been Reminded ({{count($attended_reminders)}})</span></h5>
