                ...
                <div class="p-0 card-body">
                    ...
                    <ul class="tabs-animated-shadow tabs-animated nav nav-justified tabs-shadow-bordered p-3">
                        ...
                        @if( (  $user_role == 1 && $leave->status <=40) || ($user_role == 2 && $leave->status <=30) ||  ($user_role == 3 && $leave->status <=20) ||
                               ($user_role == 4 && $leave->status ==40) || ( in_array($user_role,[5,9]) && $leave->status <= 10) )
                            <li class="nav-item">
                                    ...
                                    <div class="">
                                        <div class="row text-center">
                                            <div class="col-sm-12 mt-3">
                                                @if( ($user_role == 1 && $leave->status < 40) || ($user_role == 2 && $leave->status <=30) || ($user_role == 3 && $leave->status <=20) ||
                                                     ($user_role == 4 && $leave->status <=20) ||  ( in_array($user_role,[5,9]) && $leave->status <= 10) )
                                        ...
                                        @if( ($user_role == 1 && $leave->status <40) || ($user_role == 2 && $leave->status <=40) || ($user_role == 3 && $leave->status <=20) || ($user_role == 4 && $leave->status <=10) ||  ( in_array($user_role,[5,9]) && $leave->status <= 10) )
