    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">Time Sheet Editing (Administrator)</div>
                    <div class="page-title-subheading">
                        Edit the timesheet information and save it.
                    </div>
                </div>
            </div>
                        ...
                        <div class="mb-3 card">
                            ...
                            <div class="p-0 card-body">
                                ...
                                <div class="tab-content" style="padding-bottom: 30px;">
                                    ...
                                    <div class="tab-pane show invisible" id="tab-animated-0" role="tabpanel">
                                        <div class="">
                                            <div class="">
                                                <div class="p-3">
                                    ...
                                    <div class="tab-pane show active" id="tab-animated-2" role="tabpanel">
                                        <div class="">
                                            <div class="">
                                                <div class="p-3">
                                                    <div class="vertical-without-time vertical-timeline vertical-timeline--animate vertical-timeline--one-column">
