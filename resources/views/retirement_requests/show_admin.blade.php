            ...
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">
                       Retirement Request Submitted By <span class="text-danger font-weight-bold">{{$employee_name}}</span>
                    </div>
                    <div class="page-title-subheading">Below is information for the Retirement request</div>
                </div>
            </div>
                                                    ...
                                                    <div>
                                                        @if($travel_request->status == '0')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                ...
                                                                <p>
                                                                    This Retirement Request have been returned for corrections by
                                                        ...
                                                        @if($travel_request->status == '10')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">NEW RETIREMENT REQUEST SUBMITTED</h4>
                                                                <p>
                                                                    This Retirement Request have been submitted by employee. Currently it is still waiting for Supervisor's Approval.<br>
                                                        ...
                                                        @if($travel_request->status == '20')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                ...
                                                                <p>
                                                                    This Retirement Request have been Approved by Supervisor, currently it is waiting for Accountant Approval.<br>
                                                        ...
                                                        @if($travel_request->status == '30')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">RETIREMENT REQUEST APPROVED BY ACCOUNTANT</h4>
                                                                <p>
                                                                    This Retirement Request have been Approved by Accountant, currently it is waiting for
                                                        ...
                                                        @if($travel_request->status == '40')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                ...
                                                                <p>
                                                                    This Retirement Request have been Approved by Finance Director, currently it is waiting for
                                                        ...
                                                        @if($travel_request->status == '50')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                ...
                                                                <p>
                                                                    This retirement Request have been Approved successfully.<br>
                                                                    - Time of Approval | {{date("d-m-Y H:i:s", strtotime($travel_request->updated_at))}}
                                                                </p>
                                                        ...
                                                        @if($travel_request->status == '99')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                ...
                                                                <p>
                                                                    This Payment Request have been rejected by
                                    ...
                                    <div class="">
                                        <div class="">
                                            ...
                                            <div class="p-3" id="approve_travel_request_div">
                                                <form action="/approve_retirement_request" method="POST" enctype="multipart/form-data" id="approve_travel_request_form">
                                                    @csrf
                                                    {{ csrf_field() }}

                                                    <fieldset>
                                                        <legend class="text-primary">Approve Travel Request</legend>
                                                    ...
                                                    <button class="mt-2 btn btn-primary" id="approve_travel_request_btn">Approve Retirement Request</button>
                                                </form>
                                            </div>
                                            <div class="p-3" id="return_travel_request_div" style="display: none;">
                                                <form action="/return_retirement_request" method="POST" enctype="multipart/form-data" id="return_travel_request_form">
                                                    @csrf
                                                    {{ csrf_field() }}

                                                    <fieldset>
                                                        <legend class="text-primary">Return Retirement Request For Correction</legend>
                                                        <input name="travel_request_id" value="{{$travel_request->id}}" type="text" style="display: none;" readonly>
                                                        <div class="form-row mt-2">
                                                            <div class="col-md-12">
                                                                <div class="position-relative form-group">
                                            ...
                                            <div class="p-3" id="reject_travel_request_div" style="display: none;">
                                                <form action="/reject_retirement_request" method="POST" enctype="multipart/form-data" id="reject_form">
                                                    @csrf
                                                    {{ csrf_field() }}

                                                    <fieldset>
                                                        <legend class="text-danger">Reject Retirement Request Request</legend>
                                                        <input name="travel_request_id" value="{{$travel_request->id}}" type="text" style="display: none;" readonly>
                                                        <div class="form-row mt-2">
                                                            <div class="col-md-12">
                                                                <div class="position-relative form-group">
                                                    ...
                                                    <button class="mt-2 btn btn-danger" id="reject_travel_request_btn">Reject Retirement Request</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
