    ...
    <div class="row">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    @if( !isset($travel_request->status))
                        <form action="/payment_request" method="POST" enctype="multipart/form-data" id="valid-form">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="requested_date" id="returning_date" type="text" class="form-control" value="{{ $travel_request->returning_date}}" autocomplete="off" {{$disabled}}>
                                ...
                                <div class="col-sm-12" id="description_div">
                                    <div class="position-relative form-group">
                                        ...
                                        <textarea name="purpose_of_payment" id="purpose_of_trip" class="form-control" autocomplete="off" {{$disabled}}>{{ $travel_request->purpose_of_trip}}</textarea>
                                    ...
                                    <table style="width: 100%;" id="travel_request_lines_table" class="table table-hover table-striped table-bordered">
                                        ...
                                        <tr class="data-row" id="travel_request_table_row_1">
                                                                ...
                                                                <td class="data-column text-center">
                                                                    <input name="travel_request_table_row_1[]" class="column-input unit text-right" value="{{old('travel_request_table_row_1')[3]}}" readonly>
                                                                </td>
                                                                
                                                                <td class="data-column text-center">
                                                                    <input name="travel_request_table_row_1[]" class="column-input total-cost text-right" value="{{old('travel_request_table_row_1')[4]}}" readonly>
                                                                </td>
                                                                <td class="data-column text-center">
                                        ...
                                        @else
                                            ...
                                            <tr class="data-row" id="travel_request_table_row_{{$m}}">
                                                                    ...
                                                                    <td class="data-column time">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input account-code" autocomplete="off" value="{{ old('travel_request_table_row_'.$m)[0] }}">
                                                                    </td>
                                                                    <td class="data-column time">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input activity" autocomplete="off" value="{{ old('travel_request_table_row_'.$m)[1] }}">
                                                                    </td>
                                                                    <td class="data-column time">
                                                                    ...
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input unit text-right"  value="{{ old('travel_request_table_row_'.$m)[3] }}" readonly>
                                                                    </td>
                                                                    
                                                                    <td class="data-column text-center">
                                                                        <input name="travel_request_table_row_{{$m}}[]" class="column-input total-cost text-right"  value="{{ old('travel_request_table_row_'.$m)[4] }}" readonly>
                                                                    </td>
                                                                    <td class="data-column text-center">
        ...
        <div class="col-sm-4"  id="suggestion-div" style="display: none;">
            ...
            <div class="main-card mb-3 card summary-div" id="travel_request_summary_div">
                <div class="card-body">
                    <h5 class="card-title">
                        <span class="text-primary" id="current_year">{{date('Y')}}</span> Retirement Requests Summary
                    </h5>
