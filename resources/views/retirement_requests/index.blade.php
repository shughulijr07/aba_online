            ...
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">
                        Below is a list of Retirement request. Click on the button <strong><span class="text-danger">View</span></strong> to see more information in the travel request.
                    </div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                ...
                <tr class='clickable-row' data-href="/retirement_request/{{ $travel_request->id }}">
                    <td>{{ $n }}</td>
                    ...
                    <td>
                        <a href="/retirement_request/{{ $travel_request->id }}" class="btn btn-primary btn-sm" role="button" aria-pressed="true">View</a>
                    </td>
                </tr>
                <?php $n++; ?>
                @endforeach
