            ...
            <main>
                ...
                <div class="row pl-3 pr-3" >
                    <div class="col text-center pt-3 pb-2 " style="background-color: #ddd;">
                        <h3>EMPLOYEE RETIREMENT REQUEST</h3>
                    </div>
                </div>

                <div class="row contacts mt-2">
                    <div class="col report-to">
                        <div class="address">Payment Request No. : <strong>{{strtoupper($travel_request->id)}}</strong></div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        @include('travel_requests.statement_form')
                    </div>
                </div>
