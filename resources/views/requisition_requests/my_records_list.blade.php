    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">My Requisition Records</div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                ...
                <tr class='clickable-row-new-tab' data-href="{{url('/requisition_request_statement')}}/{{ $travel_request->id }}">
                    <td>{{ $n }}</td>
                    ...
                    <td>
                        <a href="/requisition_request_statement/{{ $travel_request->id }}" class="btn btn-primary btn-sm" role="button" aria-pressed="true" target="_blank">View</a>
                    </td>
                </tr>
                <?php $n++; ?>
                @endforeach
