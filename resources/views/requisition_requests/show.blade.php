    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">Requisition Request Submitted By {{$employee_name}}</div>
                                                    ...
                                                    <div>
                                                        @if($travel_request->status == '0')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">REQUISITION REQUEST RETURNED FOR CORRECTIONS</h4>
                                                                <p>
                                                        ...
                                                        @if($travel_request->status == '10')
                                                            ...
                                                            <div class="vertical-timeline-element-content bounce-in">
                                                                <h4 class="timeline-title text-danger">REQUISITION REQUEST SUBMITTED</h4>
                                                                <p>
