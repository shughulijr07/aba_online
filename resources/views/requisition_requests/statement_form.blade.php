    ...
    <div class="row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="requested_date" id="departure_date" type="text" class="form-control" value="{{ $travel_request->requested_date}}" autocomplete="off" {{$disabled}}>
                                ...
                                <div class="col-sm-12" id="description_div">
                                    <div class="position-relative form-group">
                                        ...
                                        <textarea name="purpose_of_use" id="purpose_of_trip" class="form-control" autocomplete="off" {{$disabled}}>{{ $travel_request->purpose_of_use}}</textarea>
                                        ...
                                        @else
                                            ...
                                            @foreach($lines as $line)
                                                <tr class="data-row @if($n == count($lines)) last-row @endif" id="{{$n}}">
                                                    ...
                                                    <td class="data-column time">
                                                        <input name="line_{{$n}}[]" class="column-input rate text-right" autocomplete="off" value="{{$line[2]}}" readonly>
                                                    </td>
        ...
        <div class="col-sm-4"  id="suggestion-div" style="display: none;">
            ...
            <div class="main-card mb-3 card summary-div" id="travel_request_summary_div">
                <div class="card-body">
                    <h5 class="card-title">
                        <span class="text-primary" id="current_year">{{date('Y')}}</span> Requisition Requests Summary
                    </h5>
