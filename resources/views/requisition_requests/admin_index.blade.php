            ...
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">
                        Below is a list of Requisition request. Click on the button <strong><span class="text-danger">View</span></strong> to see more information in the requisition request.
                    </div>
                </div>
            </div>
            ...
            <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                ...
                @foreach($travel_requests as $travel_request)
                    ...
                    <tr class='clickable-row' data-href="/travel_requests_admin/{{ $travel_request->id }}">
                        ...
                        <td>
                            <a href="/requisition_requests_admin/{{ $travel_request->id }}" class="btn btn-primary btn-sm" role="button" aria-pressed="true">View</a>
                        </td>
                    </tr>
                    <?php $n++; ?>
                @endforeach
