    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">Advance Payment Records</div>
                    <div class="page-title-subheading">
                        Use the form below to filter and see your Advance Payment records.
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <form action="/my_advance_payment_records" method="POST" enctype="multipart/form-data" id="valid-form" target="_blank">
                        @csrf
                        {{ csrf_field() }}
