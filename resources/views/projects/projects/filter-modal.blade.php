                        ...
                        <div class="form-row">
                            <div class="col-md-4">
                                <div class="position-relative form-group">
                                    <label for="number" class="">Activity Code</label>
...
<script type="text/javascript">
    ...
    function fill_datatable(filters = {}){
        $('#projectsTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('projects.ajaxGetList') }}",
    ...
    function deleteRecord(projectId, projectCode) {
        var _token = $("meta[name='csrf-token']").attr("content");
        ajaxDelete(projectId, projectCode, _token);
    }


    function ajaxDelete(projectId, projectCode, _token) {


        Swal.fire({
            title: 'You are Deleting Project ('+projectCode+') \n Are you sure?',
