    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>
                    <div class="text-primary">Edit {{$staff->first_name.' '.$staff->last_name}} Bio-Data</div>
                    <div class="page-title-subheading">
                        Please complete the form below to update staff's bio-data
                    </div>
                </div>
            </div>
        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <form action="/staff_biographical_data_sheets/{{$staff_biographical_data_sheet->id}}" method="POST" enctype="multipart/form-data">
                        @method('PATCH')
                        @include('staff.biographical_data_sheets.form')
                        <button class="mt-2 btn btn-primary">Update Staff Bio Data</button>
                    </form>
                </div>
            </div>
        </div>
